        ...
        >
          ...
          {overlays.map((o) => (
            <Rnd
              ...
              style={{
                border:
                  selectedId === o.id ? "2px solid #3b82f6" : "1px dashed rgba(255,255,255,0.4)",
                background: o.type === "button" ? "rgba(59,130,246,0.15)" : "transparent",
        ...
        {selected && (
          <div className="flex flex-col gap-3 text-sm">
            ...
            {selected.action === "timedSwap" && (
              <label className="flex flex-col gap-1">
                <span className="text-xs text-gray-400">Duración antes de revertir (segundos)</span>
                <input
                  type="number"
                  min={0.5}
                  step={0.5}
